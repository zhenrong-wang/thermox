...
- First-class `thermox_service` application module with versioned validate, steady, and transient
  ...
  values. Its `thermox.job/v14` workflow adds Team-scoped idempotent execution, leased worker claims,
...
arbitrary code. Durable jobs snapshot the exact definitions under `thermox.job/v14`. Project-owned
