...
1. Add a run-configuration editor that pins exact topology, case, and artifact revisions.
2. Add display-unit conversion to the catalog-driven component and case forms.
