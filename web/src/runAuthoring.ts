...
export const defaultSteadySolver: SteadySolverSettings = {
  ...
  structural_decomposition_policy: 'automatic',
  finite_difference_epsilon: 1e-6,
  min_damping: 1e-6,
  damping_reduction: 0.5,
  sufficient_decrease: 1e-4,
  max_line_search_steps: 50,
  globalization_policy: 'line_search',
  trust_region_initial_radius: 1,
  trust_region_minimum_radius: 1e-8,
  trust_region_maximum_radius: 1e3,
  trust_region_acceptance_threshold: 0.1,
  max_trust_region_steps: 20,
