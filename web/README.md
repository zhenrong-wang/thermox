...
- a persistent, searchable component library generated from `thermox.catalog/v12`, with
...
- on-demand retrieval of successful `thermox.result/v5` artifacts through the service;
