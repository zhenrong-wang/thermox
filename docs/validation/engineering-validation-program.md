...
gate must supply or identify component volumes. A medium-safe steady/transient finite-volume
exchanger and generic rigid receiver can then close charge; pump, expander, heat-transfer, and
pressure-loss artifacts must be frozen on cases 1--68 before cases 69--77 are opened.
