...
7. Safe custom equation DSL; no arbitrary user Python in API process.
   ...
   - constrained same-port p-h temperature, density, internal-energy, entropy, constant-pressure
     heat capacity, and explicitly two-phase vapor-quality functions with derived
   ...
   - entropy-backed isentropic, quality-backed two-phase, and heat-capacity-rate project closures
     are covered; approval policy and further derivative-backed property functions remain
     follow-ons.
