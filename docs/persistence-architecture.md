...
All gates are now in place. `thermox.job/v16` defines the Team-owned job lifecycle and idempotent
...
submission. `thermox.job/v16` captures the immutable source provenance and composed snapshot, so
