...
| Component/compiler platform | Generic typed graph, 54 built-in runtime component models, maps, correlations, expression components, structural validation, layered entity readiness, dimensioned engineering acceptance, and classified validation evidence | Preserve; extend criteria beyond absolute scalar intervals behind the Study contract |
