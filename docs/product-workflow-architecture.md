...
| Component/compiler platform | Generic typed graph, 53 built-in runtime component models, maps, correlations, expression components, structural validation | Preserve; report readiness by entity and study intent |
