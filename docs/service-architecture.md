...
- `thermox.command/v1`, `thermox.catalog/v11`, `thermox.result/v3`, and `thermox.error/v1`
  contracts;
...
| --- | --- | --- |
| Discover component, correlation-family, correlation, and regime-map templates | `SimulationService::get_catalog` | `thermox.catalog/v11` JSON |
...
| Submit a calculation | `SimulationJobService::submit` | `thermox.job/v16` JSON |
| Inspect a calculation | `SimulationJobService::get` | `thermox.job/v16` JSON |
