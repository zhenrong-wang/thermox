...
- `thermox.job/v13` Team-owned queued/running/succeeded/failed/cancelled simulation and calibration jobs with required
...
| Submit a calculation | `SimulationJobService::submit` | `thermox.job/v13` JSON |
| Inspect a calculation | `SimulationJobService::get` | `thermox.job/v13` JSON |
